...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-8 mx-4">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <button type="submit" class="w-full bg-green-500 text-white py-3 px-4 rounded-lg hover:bg-green-600 transition duration-200 font-medium">Register</button>
        </form>
        
        <div class="mt-6 text-center">
            <a href="{{ route('login') }}" class="text-blue-500 hover:text-blue-600 transition duration-200">Already have an account? Login</a>
        </div>
    </div>
</body>
</html>